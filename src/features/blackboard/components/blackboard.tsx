...
`)
    ...
    const [mobileView, setMobileView] = useState<'canvas' | 'notes'>('canvas')
    ...
    const addCloudService = useCallback((serviceName: string, icon: string, color: string) => {
        ...
        const rectangleElement = createExcalidrawElement('rectangle', { x, y, color })
    ...
    return (
        <>
            <div className="w-full flex flex-col bg-background">
                ...
                <div className="border-b px-4 py-3 flex items-center justify-between bg-card">
                    <div className="flex items-center gap-3">
                        {/* Mobile: Toggle between canvas/notes */}
                        {isMobile ? (
                            <div className="flex gap-2">
                                ...
                                <Button
                                    variant={mobileView === 'notes' ? 'default' : 'outline'}
                                    size="sm"
            ...
            <div className="h-[85dvh] w-full flex flex-col bg-background">
                {/* Main Content */}
                {isMobile ? (
